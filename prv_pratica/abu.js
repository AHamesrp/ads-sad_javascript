...
const server = express() //inicializar o server
...
server.post('./tarefas',(req, res)=>{
    ...
    //pegar as info da nova tarefa, do body da requisicao
    //lendo meu arq (readFile)
    //inserir a nova tarefa, no arq
    //salvar o arq (writeFile, appendFile)
